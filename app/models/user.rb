class User < ActiveRecord::Base
  ...
  attr_accessible :email, :password, :password_confirmation, :remember_me, :admin, :name, :address, :photo, :phone_no, :photo_file_name, :photo_content_type, :photo_file_size, :photo_updated_at, :uid, :provider
